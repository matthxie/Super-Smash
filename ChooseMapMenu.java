...
public class ChooseMapMenu implements KeyListener {	//KeyListener is like ActionListener but for keyboard
	...
	public static ArrayList <Map> allMapArray = new ArrayList <Map>(
			Arrays.asList(
				new Map(Toolkit.getDefaultToolkit().createImage("SMASHMAP0.png").getScaledInstance(width, height, java.awt.Image.SCALE_SMOOTH), new Platform[] {new Platform(140, 320 ,610, 25, false, false,false), new Platform(750, 340, 60, 20, true, false, false), new Platform(80, 340, 60, 20, true, true, false)}, 1, "FInAl DEstInAtIOn"),	
					new Map(Toolkit.getDefaultToolkit().createImage("SMASHMAP1.png").getScaledInstance(width, height, java.awt.Image.SCALE_SMOOTH), new Platform[] {new Platform(388, 205 ,120, 10,false, false, false),new Platform(250, 290 ,120, 10, false, false,false),new Platform(529, 291 ,120, 10, false, false,false),new Platform(203, 370 ,490, 25, false, false,false), new Platform(693, 390, 60, 20, true, false, false), new Platform(143, 390, 60, 20, true, true, false)}, 1, "SUnrIsE"),
					new Map(Toolkit.getDefaultToolkit().createImage("SMASHMAP2.png").getScaledInstance(width, height, java.awt.Image.SCALE_SMOOTH), new Platform[] {new Platform(400, 92 ,101, 10, false, false,false),new Platform(280, 170 ,102, 10, false, false,false),new Platform(519, 170 ,102, 10, false, false,false),new Platform(400, 245 ,101, 10, false, false,false),new Platform(158, 245 ,107, 10, false, false,false),new Platform(637, 245 ,105, 10, false, false,false),new Platform(100, 315 ,700, 25, false, false,false), new Platform(800, 335, 60, 20, true, false, false), new Platform(40, 335, 60, 20, true, true, false)}, 2, "BIg BAttlEfIEld"),
					new Map(Toolkit.getDefaultToolkit().createImage("SMASHMAP3.jpg").getScaledInstance(width, height, java.awt.Image.SCALE_SMOOTH), new Platform[] {new Platform(215, 370 ,158, 10, false, false,false),new Platform(216, 460 ,465, 25, false, false,false),new Platform(676, 90, 60, 10, true, true, false), new Platform(156, 500, 60, 10, true, true, false),new Platform(371, 266 ,310, 10, false, false,false),new Platform(217, 164 ,465, 10,false, false, false), new Platform(682, 184, 60, 20, true, false, false), new Platform(157, 184, 60, 20, true, true, false),new Platform(217, 64 ,153, 10, false, false,false),new Platform(528, 64 ,156, 10, false, false,false)}, 4, "WrEcKiNG cReW"),	
					new Map(Toolkit.getDefaultToolkit().createImage("SMASHMAP4.png").getScaledInstance(width, height-20, java.awt.Image.SCALE_SMOOTH), new Platform[] {new Platform(85, 220 ,160, 10, false, false,false),new Platform(30, 450 ,120, 10,false, false, false),new Platform(632, 255 ,268, 10, false, false,false),new Platform(405, 375 ,495, 25,false, false, false),new Platform(780, 395, 60, 20, true, false, false), new Platform(345, 395, 60, 20, true, true, false), new Platform(150, 190, 50, 240,false, false, true)}, 10, "SUzAkU CAstlE"),
					new Map(Toolkit.getDefaultToolkit().createImage("SMASHMAP5.png").getScaledInstance(width, height-20, java.awt.Image.SCALE_SMOOTH), new Platform[] {new Platform(65, 245 ,196, 10, false, false,false),new Platform(640, 245 ,196, 10, false, false,false),new Platform(194, 350 ,170, 10,false, false, false),new Platform(530, 345 ,172, 10, false, false,false),new Platform(324, 445 ,250, 10, false, false,false),new Platform(574, 465, 60, 20, true, false, false), new Platform(264, 465, 60, 20, true, true, false)}, 3, "NOrfAIr")	
	...
	public void keyPressed(KeyEvent e) {
		...
		else if(e.getKeyCode() == KeyEvent.VK_UP) {	//Go up to map settings button
			onSettings = true;
		}
		else if(e.getKeyCode() == KeyEvent.VK_DOWN) {	//Go down to map selection
			onSettings = false;
		}
