...
public class ChooseMapMenu implements KeyListener {	//KeyListener is like ActionListener but for keyboard
	...
	public static Map[] allMapArray = new Map[] {//Toolkit.getDefaultToolkit().createImage("FINALDESTINATION.png").getScaledInstance(width, height, java.awt.Image.SCALE_SMOOTH),
			...
			new Map(Toolkit.getDefaultToolkit().createImage("SMASHMAP3.jpg").getScaledInstance(width, height, java.awt.Image.SCALE_SMOOTH), new Platform[] {new Platform(215, 370 ,158, 5, false, true, false),new Platform(216, 460 ,465, 5, false, true, false),new Platform(371, 266 ,310, 5, false, true, false),new Platform(217, 164 ,465, 5, false, true, false),new Platform(217, 64 ,153, 5, false, true, false),new Platform(528, 64 ,156, 5, false)}, 4, "WrEcKiNG cReW"),		
			new Map(Toolkit.getDefaultToolkit().createImage("SMASHMAP4.png").getScaledInstance(width, height-20, java.awt.Image.SCALE_SMOOTH), new Platform[] {new Platform(85, 220 ,160, 5, false, true, false),new Platform(30, 450 ,120, 5, false, true, false),new Platform(632, 255 ,268, 5, false, true, false),new Platform(405, 375 ,495, 5, false, true, false), new Platform(150, 190, 50, 240, false, true, true)}, 5, "SUzAkU CAstlE"),		
			new Map(Toolkit.getDefaultToolkit().createImage("SMASHMAP5.png").getScaledInstance(width, height-20, java.awt.Image.SCALE_SMOOTH), new Platform[] {new Platform(65, 245 ,196, 5, false, true, false),new Platform(640, 245 ,196, 5, false, true, false),new Platform(194, 350 ,170, 5, false, true, false),new Platform(530, 345 ,172, 5, false, true, false),new Platform(324, 445 ,250, 5, false, true, false)}, 3, "NOrfAIr"),		
